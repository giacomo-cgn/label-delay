...
import torch
from src.strategies.train_fgdumb import train_fgdumb
from src.strategies.train_nncsl import train_nncsl
...
def main(args):
    ...
    if args.model == 'nncsl':
        train_nncsl(args, log_folder, device)
    elif args.model == 'fgdumb':
        train_fgdumb(args, log_folder, device)
    else:
